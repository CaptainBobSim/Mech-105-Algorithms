...
% This function determines the root of x = g(x) with fixed-point ite
% The method is repeated until either the percent relative error (ea
% is equal to or less than es (default: 1.e-6) or the number of itera
...
if nargin < 4||isempty(maxit),maxit = 50 ;end %if maxit is blank set
